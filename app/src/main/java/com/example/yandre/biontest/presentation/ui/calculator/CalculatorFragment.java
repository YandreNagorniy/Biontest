...
import com.example.yandre.biontest.data.repositiry.CalculatorRepositoryImpl;
...
public class CalculatorFragment extends Fragment implements CalculatorView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        calculatorPresenter = new CalculatorPresenterImpl(this, new CalculatorRepositoryImpl(App.getInstance().getDatabase()));
